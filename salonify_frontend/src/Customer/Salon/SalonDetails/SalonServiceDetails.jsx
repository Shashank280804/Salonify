    ...
    return (
        <div className='lg:flex gap-5 h-[90vh] mt-10'>
            ...
            <section className='space-y-2 lg:w-[50%] px-5 lg:px-20 overflow-y-auto'>
                ...
                {[1, 1, 1, 1, 1, 1, 1].map((item, index) => (<div className='space-y-4'><ServiceCard item={index} added={added.includes(index)} handleAdd={() => handleAdd(index)} />
                    <Divider />
                </div>))}
            </section>
                ...
                <div className=' border rounded-md p-5'>
                    {true ?
                        <div>
                            ...
                            <SelectedServiceList />
                            <Button sx={{ py: ".7rem" }} fullWidth variant='contained'>Book</Button>
                        </div>
                        :
